    ...
    b.prototype = {
        _generate: function () {
            return a.support.canvas ? (this.canvas = document.createElement("canvas"),
                ...
                this.init = !0, void this.reset()) : (this.$el.append("Canvas is not supported in this browser."), !0)
        },
        reset: function () {
            var b = this,
            ...
            this.pixels = c * d,
                ...
                this.options.fg && ("#" === this.options.fg.charAt(0) ? (this.ctx.fillStyle = this.options.fg, this.ctx.beginPath(),
        ...
        clear: function () {
            this.ctx.clearRect(0, 0, Math.ceil(this.$el.innerWidth()),
